...
```
stack_demo_fs_public        <- Root directory. Both monorepo and polyrepo are supported.
│
├── stack_demo_fs_public       <- Contains python code, notebooks and ML assets related to one ML project. 
│   │
...
and [ML asset config guide](stack_demo_fs_public/assets/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML assets, e.g. model training or inference jobs  | [ML asset config guide](stack_demo_fs_public/assets/README.md)                                                     |
