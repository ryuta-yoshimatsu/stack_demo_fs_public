...
# ``stack_demo_fs_public/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-stack_demo_fs_public-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.stack_demo_fs_public.stack_demo_fs_public-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.stack_demo_fs_public.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.stack_demo_fs_public.trip_dropoff_features",
